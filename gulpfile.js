...
const styleFiles = [
  ...
  'app/scss/style.scss', // Пользовательские стили
]
...
function browsersync() {
  //название функции не должно совпадать с названием переменной
  browserSync.init({
...
function startwatch() {
  // автоматическое обновление при сохранении скриптов
